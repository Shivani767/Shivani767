...
| ------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------- |
| **[Apertus Eval Prep](https://github.com/Shivani767/apertus-eval-prep)** | Reproducible LLM evaluation across models, prompts, inference configurations, and hardware   |
| **[InferLite](https://github.com/Shivani767/llm-inferlite)**             | Hardware-aware inference optimization using latency, throughput, memory, and Pareto analysis |
| **[IndicQuant](https://github.com/Shivani767/IndicQuant)**               | Efficient evaluation and optimization for Indic-language document AI                         |
